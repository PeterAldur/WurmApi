using AldursLab.PersistentObjects.Tests.PersistentCollectionsLibraryTests.Data;
using NUnit.Framework;

namespace AldursLab.PersistentObjects.Tests.PersistentCollectionsLibraryTests.Tests
{
    [TestFixture]
